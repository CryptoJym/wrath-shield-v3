-- Migration 057: Forge v4 Fixes
-- Adds missing tables required by the v4 multi-agent assessment system

-- =============================================================================
-- GENERATED ITEMS LOG TABLE
-- Required by forge-generative-engine.ts for auditing and analysis
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_gen_items_student ON hyro_generated_items_log(student_id);
CREATE INDEX IF NOT EXISTS idx_gen_items_strand ON hyro_generated_items_log(strand);
CREATE INDEX IF NOT EXISTS idx_gen_items_stat ON hyro_generated_items_log(stat_name);

-- =============================================================================
-- GENERATIVE SESSIONS TABLE
-- If missing, create for session tracking
-- =============================================================================
...
-- =============================================================================
-- GENERATIVE RESULTS TABLE
-- For completed generative diagnostics
-- =============================================================================
